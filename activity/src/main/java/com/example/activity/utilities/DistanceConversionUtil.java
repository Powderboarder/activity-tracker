...
public class DistanceConversionUtil {
    ...
    public static BigDecimal convertDistance(final BigDecimal distance,
            final ActivityDistanceEnum fromDistanceType, final ActivityDistanceEnum toDistanceType)
    {
    ...
    public static BigDecimal convertToFeet(final BigDecimal distance,
    ...
    public static BigDecimal convertToMiles(final BigDecimal distance,
            final ActivityDistanceEnum fromDistanceType)
    {
        BigDecimal convertedDistance = distance;
    ...
    public static BigDecimal convertToMeters(final BigDecimal distance,
            final ActivityDistanceEnum fromDistanceType)
    {
        BigDecimal convertedDistance = distance;
        if (fromDistanceType == ActivityDistanceEnum.FEET)
    ...
    public static BigDecimal convertKilometersToMiles(final BigDecimal distance)
    {
        ...
        {
            convertedDistance =
                    distance.multiply(MILES_IN_KILOMETER).setScale(2, RoundingMode.HALF_UP);
        }
        return convertedDistance;
    }
}
